...
img_fundo = add_image_loaded( PATH_INIT + 'fundo.jpg' )
img_logo  = add_image_loaded( PATH_INIT + 'JetTowers-Logo.png' )
img_inic  = add_image_loaded( PATH_INIT + 'init_img\\' + 'inic.png')
img_posi  = add_image_loaded( PATH_INIT + 'init_img\\' + 'posi.jpg')
img_atua  = add_image_loaded( PATH_INIT + 'init_img\\' + 'conf.png') 
img_sens  = add_image_loaded( PATH_INIT + 'init_img\\' + 'sens.png')
img_comu  = add_image_loaded( PATH_INIT + 'init_img\\' + 'comu.jpg')  
...
def init_inicio( windows : dict, callback ): 
    ...
    with dpg.window( label = 'Lateral', tag = 1_2, no_move= True , no_close = True , no_title_bar= True, no_resize= True ) as Lateral_IN:
        ...
        dpg.add_button(  label = "RedNode Comunicação", tag = 1_2_55, arrow  = False, callback = callback, user_data   = "Rednode comunicacao" )
